...
import expandable.ExpandableListAdapter22;

/**
 * Created by aasaqt on 10/2/15.
 */
public class ComputerQuiz extends BaseActivity {
    ExpandableListAdapter22 listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.computerquiz);
        ...
        listAdapter = new ExpandableListAdapter22(this, listDataHeader, listDataChild);
    ...
    private void prepareListData() {
        ...
        intro.add("Computer quiz is a general quiz related to computers. No core technical knowledge will be tested in this quiz. The general awareness in the world of computers will be. Test your knowledge and wits at the Computer Quiz!");
        ...
        prize.add("1st worth 3000 , 2nd worth 1000");
        ...
        getActionBar().setTitle("Computer Quiz");
