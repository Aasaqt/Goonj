...
import expandable.ExpandableListAdapter20;

/**
 * Created by aasaqt on 10/2/15.
 */
public class SportQuiz extends BaseActivity {
    ExpandableListAdapter20 listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.sportquiz);
        ...
        listAdapter = new ExpandableListAdapter20(this, listDataHeader, listDataChild);
    ...
    private void prepareListData() {
        ...
        intro.add("If you think your sports trivia can turn heads more on the paper than on the field, You have come at the right place. Try your luck at UIET’s annual sports quiz.");
        ...
        getActionBar().setTitle("Sport Quiz");
